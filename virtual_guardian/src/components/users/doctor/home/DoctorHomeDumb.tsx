  ...
  return (
    <>
      <div style={{ position: 'relative' }}>
        ...
        <img alt="mountains_2" src={mountains_2} style={{ position: 'absolute', right: 0, marginTop: '20vh', transform: `translateY(-${offsetY * 0.6}px)` }} />
        <img alt="mountains_1" src={mountains_1} style={{ position: 'absolute', left: 0, marginTop: '30vh', transform: `translateY(-${offsetY * 0.9}px)` }} />
        ...
        <img alt="foreground" src={foreground} style={{ position: 'absolute', left: 0, marginTop: '45vh', transform: `translateY(-${offsetY * 1.4}px)` }} />
